# Vivado 2019 project setup for morse_uart_decoder
# Usage examples:
#   vivado -mode batch -source scripts/create_vivado_2019_project.tcl
#   vivado -mode batch -source scripts/create_vivado_2019_project.tcl -tclargs xcku040-ffva1156-2-e morse_uart_decoder_vivado
...
set proj_name "morse_uart_decoder_vivado"
