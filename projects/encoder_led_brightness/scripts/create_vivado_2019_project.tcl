# Vivado 2019 project setup for encoder_led_brightness
# Usage examples:
#   vivado -mode batch -source scripts/create_vivado_2019_project.tcl
#   vivado -mode batch -source scripts/create_vivado_2019_project.tcl -tclargs xcku040-ffva1156-2-e encoder_led_brightness_vivado
...
set proj_name "encoder_led_brightness_vivado"
...
set rtl_file [file normalize [file join $origin_dir rtl encoder_led_brightness.sv]]
set tb_top_file [file normalize [file join $origin_dir tb tb.sv]]
set xdc_file [file normalize [file join $origin_dir constraints encoder_led_brightness.xdc]]
...
set_property top encoder_led_brightness [get_filesets sources_1]
