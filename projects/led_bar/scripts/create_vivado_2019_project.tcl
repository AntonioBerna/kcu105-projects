# Vivado 2019 project setup for led_bar
# Usage examples:
#   vivado -mode batch -source scripts/create_vivado_2019_project.tcl
#   vivado -mode batch -source scripts/create_vivado_2019_project.tcl -tclargs xcku040-ffva1156-2-e led_bar_vivado
...
set rtl_file [file normalize [file join $origin_dir rtl led_bar.sv]]
...
set_property top led_bar [get_filesets sources_1]
